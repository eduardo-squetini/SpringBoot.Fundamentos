package br.com.eduardosquetini.controller;
...
public class primeiraController {
   ...
   public String metodoComQueryParams(@RequestParam String id) {
      return "O parametro com metodoComQueryPrams é " + id;

   }

   @GetMapping("/metodoComQueryParams2")
   public String metodoComQueryParams2(@RequestParam Map<String, String> allParams) {
      return "O parametro com metodoComQueryPrams é " + allParams.entrySet();
   ...
   public ResponseEntity<Object> metodoResponseEntity(@PathVariable Long id){
      var usuario = new Usuario("edusquetini");
